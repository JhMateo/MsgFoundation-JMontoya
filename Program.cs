       ...
       var  nameTask = task.TopicName;
        ...
        switch (nameTask)
        {
            ...
            case "ValidateCredentials":
                ...
                break;
            case "ExistMotociclista":
                await MotociclistaFunctions.ExistMotociclista(task, dbcontext, camunda);
                break;
            case "CreateMotociclista":
                await MotociclistaFunctions.CreateMotociclista(task, dbcontext, camunda);
                break;
            case "ValidateMotociclista":
                await MotociclistaFunctions.ValidateMotociclista(task, dbcontext, camunda);
                break;
            ...
            case "CreditCompletionReport":
                ...
                break;
            case "CreateTecnomecanica":
                await TecnomecanicaFunctions.CreateTecnomecanica(task, dbcontext, camunda);
                break;
            default:
                break;
        }
